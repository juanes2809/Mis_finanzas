  ...
  return (
    <div style={S.page}>
      <div style={{ textAlign: "center", padding: "20px 0 24px" }}>
        ...
        <div style={{ fontSize: "38px", fontWeight: 800, marginTop: "6px", color: balance >= 0 ? "#52b788" : "#e07a5f" }}>{fmt(balance)}</div>
      </div>
      <div style={S.statGrid}>
        <div style={S.statCard("#52b788")}>
          <div style={S.statLabel}>Ingresos</div>
          <div style={{ ...S.statVal, color: "#52b788", fontSize: "18px" }}>{fmt(totalIncome)}</div>
        </div>
        <div style={S.statCard("#e07a5f")}>
          <div style={S.statLabel}>Gastos</div>
          <div style={{ ...S.statVal, color: "#e07a5f", fontSize: "18px" }}>{fmt(totalExpense)}</div>
        </div>
      </div>
      {goals.length > 0 && (
        <div style={S.card}>
            ...
            return (
              <div key={g.id} style={{ marginBottom: "14px" }}>
                ...
                <div style={{ background: "rgba(255,255,255,0.08)", borderRadius: "3px", height: "6px" }}>
                  <div style={S.goalBar(100, g.color)} />
                </div>
                <div style={{ fontSize: "11px", color: "rgba(240,236,227,0.4)", marginTop: "3px" }}>
                  {g.percentage}% de ingresos ({g.period === "weekly" ? "semanal" : g.period === "daily" ? "diario" : "mensual"})
                </div>
              </div>
            );
          })}
